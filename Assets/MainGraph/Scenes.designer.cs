...
public class InGameSceneBase : uFrame.Kernel.Scene {
    
    public override string DefaultKernelScene {
        get {
            return "uFrameProjRepoKernelScene";
        }
    }
    
    public virtual InGameSceneSettings Settings {
        get {
            return _SettingsObject as InGameSceneSettings;
        }
        set {
...
public class InGameSceneLoaderBase : SceneLoader<InGameScene> {
